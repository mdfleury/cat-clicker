...
module.exports = "<div class=\"cat-clicker\">\n  <select [(ngModel)]=\"selectedCat\">\n    <option *ngFor=\"let cat of cats\" [ngValue]=\"cat\">{{cat.name}}</option>\n  </select>\n</div>\n<div *ngIf=\"selectedCat\" class=\"cat\">\n  <p>{{selectedCat.name}}</p>\n  <img (click)=\"clickCat()\" src=\"{{selectedCat.url}}\"/>\n  <p>Clicked {{selectedCat.clicks}} times</p>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cat_service__ = __webpack_require__("./src/app/cat.service.ts");
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.catService.getCats()
            .then(function (cats) {
            _this.cats = cats;
            _this.selectedCat = cats[0];
        });
    };
    AppComponent.prototype.clickCat = function () {
...
AppComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_4" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__cat_service__["a" /* CatService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__cat_service__["a" /* CatService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__cat_service__["a" /* CatService */]) === "function" && _a || Object])
], AppComponent);
